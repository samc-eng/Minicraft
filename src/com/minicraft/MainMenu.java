...
public class MainMenu {
    ...
    public void show(Stage window) {
        ...
        try {
            java.net.URL musicUrl = getClass().getResource("/menu_music.mp3");
            if (musicUrl != null) {
                Media hit = new Media(musicUrl.toExternalForm());
        ...
        try {
            java.net.URL bgUrl = getClass().getResource("/bg.png");
            if (bgUrl != null) {
                javafx.scene.image.Image backgroundImage = new javafx.scene.image.Image(bgUrl.toExternalForm());
    ...
    private void loadExistingGame(Stage window) {
        ...
        try {
            ...
            p.getInventory().add(1, Integer.parseInt(pData[2])); p.getInventory().add(2, Integer.parseInt(pData[3]));
            String line = "";
